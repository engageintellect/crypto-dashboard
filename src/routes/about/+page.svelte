...
<div class="flex  flex-col gap-5 text-base-content px-2 font-thin text-lg">
	<div class="text-4xl font-semibold text-neutral-content">About Fear & Greed:</div>

	<div class="bg-base-100 p-4 text-xl  shadow-md italic">
	...
	<table class="table text-sm shadow-md font-semibold">
		<thead>
			<tr>
	...
	<div class="flex flex-col gap-5">
		<div class="flex flex-col gap-5 bg-base-100 p-4 ">
			<div class="text-3xl font-semibold text-neutral-content">
		...
		<div class="flex flex-col gap-5 bg-base-100 p-4 ">
			<div class="text-3xl font-semibold text-neutral-content">How can it be used for Bitcoin?</div>

			<div>
				Bitcoin is a <strong>highly</strong> volatile asset, and emotions often play a significant role
		...
		<div class="flex flex-col gap-5 bg-base-100 p-4 ">
			<div class="text-3xl font-semibold text-neutral-content">Conclusion</div>
	...
	<div class="flex flex-col gap-5 my-10 bg-base-100 p-4  shadow-md">
		<div class="text-4xl font-semibold text-neutral-content">The Algorithm</div>

		<div class="bg-base-300  shadow-md p-4">
			...
			<div>
				...
				corresponding average values of the last 30 days and 90 days. We argue that an unusual rise
				in volatility is a sign of a fearful market.
			</div>
		</div>

		<div class="bg-base-300  shadow-md p-4">
			<div class="text-2xl font-semibold text-neutral-content">Market Momentum/Volume (25%)</div>
			<div>
				...
				high buying volumes in a positive market on a daily basis, we conclude that the market acts
				overly greedy / too bullish.
			</div>
		</div>
		<div class="bg-base-300  shadow-md p-4">
			...
			<div>
				...
				(publicly, we show only those for Bitcoin) and check how fast and how many interactions they
				receive in certain time frames). A unusual high interaction rate results in a grown public
				interest in the coin and in our eyes, corresponds to a greedy market behaviour.
			</div>
		</div>
		<div class="bg-base-300  shadow-md p-4">
			...
			<div>
				...
				see the market. Usually, we’re seeing 2,000 - 3,000 votes on each poll, so we do get a
				picture of the sentiment of a group of crypto investors. We don’t give those results too
		...
		<div class="bg-base-300  shadow-md p-4">
			...
			<div>
				...
				chance in next big bull run. Anyhow, analyzing the dominance for a coin other than Bitcoin,
				you could argue the other way round, since more interest in an alt-coin may conclude a
				bullish/greedy behaviour for that specific coin.
			</div>
		</div>
		<div class="bg-base-300  shadow-md p-4">
